...
set.seed( 123 )
af4_model_2_ci <- get_CI( af4_model_2, n_boot = 1000, type = 'perc' )
af4_model_2_ci

results_af4_model_2 <- data.frame(
  estimate = round( af4_model_2$contrast_est, 2 ),
  lower_ci = round( af4_model_2_ci$ci_contrast$percent[4], 2 ),
  upper_ci = round( af4_model_2_ci$ci_contrast$percent[5], 2 ) ) %>%
  mutate( model = "af4_model_2",
          sample_size = nrow( d_af4 ) )
results_af4_model_2
```
...
set.seed( 123 )
af4_model_3_ci <- get_CI( af4_model_3, n_boot = 1000, type = 'perc' )
af4_model_3_ci

results_af4_model_3 <- data.frame(
  estimate = round( af4_model_3$contrast_est, 2 ),
  lower_ci = round( af4_model_3_ci$ci_contrast$percent[4], 2 ),
  upper_ci = round( af4_model_3_ci$ci_contrast$percent[5], 2 ) ) %>%
  mutate( model = "af4_model_3",
          sample_size = nrow( d_af4 ) )
results_af4_model_3
```
...
set.seed( 123 )
af4_model_4_ci <- get_CI( af4_model_4, n_boot = 1000, type = 'perc' )
af4_model_4_ci

results_af4_model_4 <- data.frame(
  estimate = round( af4_model_4$contrast_est, 2 ),
  lower_ci = round( af4_model_4_ci$ci_contrast$percent[4], 2 ),
  upper_ci = round( af4_model_4_ci$ci_contrast$percent[5], 2 ) ) %>%
  mutate( model = "af4_model_4",
          sample_size = nrow( d_af4 ) )
results_af4_model_4
```
...
desired_order <- c( "Complete-case analysis", "mi_model_1", "mi_model_2", "af4_model_2", "mi_model_3", "af4_model_3", "mi_model_4", "af4_model_4" )
...
results_all$model[ results_all$model == "mi_model_1" ] <- paste0( "   ", "MI" )
results_all$model[ results_all$model == "mi_model_2" ] <- paste0( "   ", "MI" )
results_all$model[ results_all$model == "af4_model_2" ] <- paste0( "   ", "MIA" )
results_all$model[ results_all$model == "mi_model_3" ] <- paste0( "   ", "MI" )
results_all$model[ results_all$model == "af4_model_3" ] <- paste0( "   ", "MIA" )
results_all$model[ results_all$model == "mi_model_4" ] <- paste0( "   ", "MI" )
results_all$model[ results_all$model == "af4_model_4" ] <- paste0( "   ", "MIA" )
