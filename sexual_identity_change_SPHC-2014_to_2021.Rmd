...
set.seed( 123 )
mia_model_2_ci <- get_CI( mia_model_2, n_boot = 1000, type = 'perc' )
mia_model_2_ci

results_mia_model_2 <- data.frame(
  estimate = round( mia_model_2$contrast_est, 2 ),
  lower_ci = round( mia_model_2_ci$ci_contrast$percent[4], 2 ),
  upper_ci = round( mia_model_2_ci$ci_contrast$percent[5], 2 ) ) %>%
  mutate( model = "mia_model_2",
...
desired_order <- c( "Complete-case analysis", "mi_model_1", "mi_model_2", "mia_model_2", "mi_model_3", "mia_model_3", "mi_model_4", "mia_model_4" )
...
results_all$model[ results_all$model == "mia_model_2" ] <- paste0( "   ", "MIA" )
results_all$model[ results_all$model == "mi_model_3" ] <- paste0( "   ", "MICE" )
results_all$model[ results_all$model == "mia_model_3" ] <- paste0( "   ", "MIA" )
results_all$model[ results_all$model == "mi_model_4" ] <- paste0( "   ", "MICE" )
results_all$model[ results_all$model == "mia_model_4" ] <- paste0( "   ", "MIA" )
